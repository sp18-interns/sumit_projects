...
recipe_name = ["Dum Aloo Lakhnavi", "Honey Chilli Potatoes", "Gratin of Potatoes with Garlic Cream", "Bangbang Batata",
               "Heeng Aur Dhaniye Ke Chatpate Aloo", "Aloo Lafde Wala"]
